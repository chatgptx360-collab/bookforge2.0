...
export const KOKORO_VOICES: TtsVoice[] = [
  ...
  // Blended, not shipped by Kokoro — see utils/voiceBlends.ts. The id is a
  // stock voice's because the library's catalogue is frozen and will not take
  // a new one; the tensor behind it is not.
  { id: 'af_river', grade: 'C', name: 'Cole', character: 'Grounded', timbre: 'deep', gender: 'male',
    goodFor: 'Low and full, built for short-form storytime (American)',
    bestFor: ['Short-form video', 'Story narration', 'True crime'] },
  { id: 'am_echo', grade: 'C', name: 'Sadie', character: 'Unhurried', timbre: 'bright', gender: 'female',
    goodFor: 'High and clear, but leaves room to breathe (American)',
    bestFor: ['Short-form video', 'Voiceover', 'Explainers'] },
